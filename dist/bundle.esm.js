...
function Test() {
  return /*#__PURE__*/react.createElement("h2", null, "Hello world");
}
...
function FormattedDate(_ref) {
  ...
  var isFromNow = format === formats["fromNow"];
  return /*#__PURE__*/react.createElement(Moment, {
    format: !isFromNow && formats[format],
    fromNow: isFromNow
  }, children);
}
